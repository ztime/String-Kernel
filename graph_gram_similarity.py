...
def create_plot():
    ...
    # prefix_inv_features = "pickels/gram_matrix_%d_inv_features_100_first_documents_k_3_lambda_0_5_NORMALIZED.pkl"
    ...
    feature_range_2 = [ x for x in range(200, 9600, 200) ]
    ...
    plt.axis([ 0, 10000, 0.7, 1.01])
    plt.legend(['Reference', 'Frequent','Infrequent', 'Random'], loc='lower right')
    plt.show()
